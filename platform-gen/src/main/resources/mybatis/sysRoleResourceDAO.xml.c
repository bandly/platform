...
<mapper namespace="com.xuhe.platform.dal.SysRoleResourceDAO">
    ...
    <insert id="insert" parameterType="com.xuhe.platform.dal.model.SysRoleResourceDO" useGeneratedKeys="true">
        ...
        values
        (<trim prefix="(" suffix=")" suffixOverrides=",">#{resourceId,jdbcType=INT},#{remark,jdbcType=VARCHAR},#{createTime,jdbcType=DATETIME},#{updateTime,jdbcType=DATETIME},#{isDelete,jdbcType=BIT},</trim>)
    </insert>
