package com.xuhe.platform.web.aspect;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Lists;
import com.xuhe.platform.common.util.IpUtil;
...
import com.xuhe.platform.web.handler.GlobalExceptionHandler;
...
public class RestControllerAspect {
    ...
    public Object apiLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Optional<String> userId = LoginContextHelper.getLoginUserId();
        if(userId.isPresent()){
            requester = userId.get();
        }
